...
void Vcal_phase_cal_phase::_settle__TOP__cal_phase__7(Vcal_phase__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcal_phase_cal_phase::_settle__TOP__cal_phase__7\n"); );
...
void Vcal_phase_cal_phase::_settle__TOP__cal_phase__8(Vcal_phase__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcal_phase_cal_phase::_settle__TOP__cal_phase__8\n"); );
    Vcal_phase* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vcal_phase_cal_phase::_ctor_var_reset() {
    ...
    __PVT__vin1_reg = VL_RAND_RESET_I(8);
    __PVT__vin2_reg = VL_RAND_RESET_I(8);
    __PVT__vin_vld_reg = VL_RAND_RESET_I(1);
    ph_vld = VL_RAND_RESET_I(1);
    __PVT__calvn__DOT__vin_vld_d1 = VL_RAND_RESET_I(1);
    __PVT__calvn__DOT__vin_vld_d2 = VL_RAND_RESET_I(1);
    __PVT__calvn__DOT__vin1_bias_shift = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__vin2_bias_shift = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_0 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_1 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_2 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_3 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_4 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_5 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_6 = VL_RAND_RESET_I(8);
    __PVT__calvn__DOT__V_bias_ac_7 = VL_RAND_RESET_I(8);
    ...
    __PVT__dot__DOT__booth_sin__DOT___zz_2 = VL_RAND_RESET_I(19);
    __PVT__dot__DOT__booth_sin__DOT__Breg = VL_RAND_RESET_I(8);
    __PVT__dot__DOT__booth_sin__DOT__shiftReg = VL_RAND_RESET_I(19);
    __PVT__dot__DOT__booth_sin__DOT__PositiveB = VL_RAND_RESET_I(10);
    __PVT__dot__DOT__booth_sin__DOT__AddB = VL_RAND_RESET_I(10);
    __PVT__dot__DOT__booth_sin__DOT__MinusB = VL_RAND_RESET_I(10);
    ...
    __PVT__dot__DOT__booth_cos__DOT___zz_2 = VL_RAND_RESET_I(19);
    __PVT__dot__DOT__booth_cos__DOT__Breg = VL_RAND_RESET_I(8);
    __PVT__dot__DOT__booth_cos__DOT__shiftReg = VL_RAND_RESET_I(19);
    __PVT__dot__DOT__booth_cos__DOT__PositiveB = VL_RAND_RESET_I(10);
    __PVT__dot__DOT__booth_cos__DOT__AddB = VL_RAND_RESET_I(10);
    __PVT__dot__DOT__booth_cos__DOT__MinusB = VL_RAND_RESET_I(10);
    ...
    __PVT__cordic__DOT__cal_start_regNext = VL_RAND_RESET_I(1);
    __PVT__cordic__DOT__nozero_flg_regNext = VL_RAND_RESET_I(1);
