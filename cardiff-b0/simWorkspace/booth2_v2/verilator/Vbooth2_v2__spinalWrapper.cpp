...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/mnt/mydata/spinal_works/cardiff-b0/./simWorkspace/booth2_v2/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/mnt/mydata/spinal_works/cardiff-b0/./simWorkspace/booth2_v2/") + name + ".dat").c_str());
      #endif
    }
