...
#set_target_library_subset "tcbn28hpcplusbwp7t35p140ssg0p81v0c_ccs.db" -object_list [get_cells {u_pll_avs_config u_spi_chip_rx u_spi_chip_tx u_cdc_s2f u_cdc_f2s}] 


#set_target_library_subset "tcbn28hpcplusbwp7t35p140ssg0p72v0c_ccs.db tcbn28hpcplusbwp7t35p140ssg0p5v0p72v0c_ccs.db" -object_list [get_cells {u_sram_all}]

set_target_library_subset "tcbn28hpcplusbwp7t35p140ssg0p5v0c_ccs.db" -object_list [get_cells {U_OCT_LOGIC_TOP_0}] 

#EHVT acc_v3
set_target_library_subset "tcbn28hpcplusbwp7t40p140ehvttt0p5v0c_ccs.db" -object_list [get_cells {U_OCT_LOGIC_TOP_0/U_PE_SET_WITH_BUS_0/U_PE_SET_0/*U_PE_TOP_0/U_PE_0/U_LOAD_FMAP_0/U_FEATURE_PAD_0 U_OCT_LOGIC_TOP_0/U_PE_SET_WITH_BUS_0/U_PE_SET_0/*U_PE_TOP_0/U_PE_0/U_LOAD_WEIGHT_0/U_WEIGHT_PAD_0 U_OCT_LOGIC_TOP_0/U_PE_SET_WITH_BUS_0/U_PE_SET_0/*U_PE_TOP_0/U_PE_0/U_PSUM_PAD_0}]

#U_OCT_LOGIC_TOP_0/U_PE_SET_WITH_BUS_0/U_MASK_MEM_CONNECTOR_0/*U_MASK_MEM_REG_0
# -----------------------------------------------------------------------
#                    ssg0p81vm40c
# -----------------------------------------------------------------------
