...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/mnt/mydata/spinal_works/cal_phase/./simWorkspace/cal_phase/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/mnt/mydata/spinal_works/cal_phase/./simWorkspace/cal_phase/") + name + ".dat").c_str());
      #endif
    }
